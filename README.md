...
> **Sample on GitHub** · `AMZN_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 3.59 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/amzn)** — **637,283** `1m` rows (full `1m`: 637,283), **11 timeframes**, `2020-02-25` -> `2026-09-01`.
...
The complete **AMZN** archive on **[getdata.finance](https://getdata.finance/datasets/amzn)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **637,283** rows at `1m`, plus all other timeframes in the same ZIP.
