...
> **Sample on GitHub** · `AMZN_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 3.59 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/amzn)** — **637,283** `1m` rows, **11 timeframes**, `2020-02-25` -> `2026-09-01`.
